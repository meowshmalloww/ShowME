...
export function ProviderIcon({ provider, size = 22 }: { provider: ProviderId; size?: number }) {
  ...
  if (provider === "cerebras") {
    return (
      <svg aria-hidden="true" height={size} viewBox="0 0 24 24" width={size}>
        <path
          d="M12.1 22.4A10.4 10.4 0 1 1 12.1 1.6v2.1a8.3 8.3 0 1 0 0 16.6v2.1Z"
          fill="currentColor"
        />
        <path
          d="M13 8.5a4.1 4.1 0 1 0 0 7v-2.1a2.1 2.1 0 1 1 0-2.8l1.5-1.5A4.1 4.1 0 0 0 13 8.5Z"
          fill="currentColor"
        />
      </svg>
    );
  ...
  return (
    <svg aria-hidden="true" height={size} viewBox="0 0 24 24" width={size}>
      <circle cx="7" cy="7" fill="none" r="3" stroke="currentColor" strokeWidth="2" />
      <circle cx="17" cy="7" fill="currentColor" r="2" />
      <circle cx="7" cy="17" fill="currentColor" r="2" />
      <path
        d="M14 13h4v5h-5a6 6 0 0 1-6-6"
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
        strokeWidth="2"
...
function PathIcon({ path, size }: { path: string; size: number }) {
  return (
    <svg aria-hidden="true" height={size} viewBox="0 0 24 24" width={size}>
